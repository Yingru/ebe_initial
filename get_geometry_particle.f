!	evolve all ptcicles (only free streaming at this moment)
	subroutine get_geometry_particle(N_ptc, mean_x, mean_y, eps_n, phi_n, v_n)
...
!       shift positions (x,y) of original binary collisions
        do i_n1 = 1, atom_A
            do i_n2 = 1, atom_B
                x_coll(i_n1, i_n2) = x_coll(i_n1, i_n2) - mean_x
                y_coll(i_n1, i_n2) = y_coll(i_n1, i_n2) - mean_y
            end do
        end do
